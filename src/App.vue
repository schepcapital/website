...
<template>
  ...
  <div class="background">
    ...
    <ReturnsOverview metric="usdt">
      <p>
        This table presents the <strong>impressive</strong> historical returns in terms of USD,
        both back-tested and real world <strong>results</strong>.
        <br><br>
        ...
        The strategy is <strong>fully automated</strong> and strictly trades cryptocurrencies.
    ...
    <ReturnsOverview metric="btc">
      <p>
        This table displays the historical returns generated by the trading strategy in terms of Bitcoin.
        <br><br>
