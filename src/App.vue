...
<!--        Over the long run, this approach significantly outperforms <strong>traditional</strong> investment methods.-->
    ...
    <ReturnsOverview metric="usdt">
      <p>
        This second table presents the <strong>impressive</strong> historical returns in terms of <strong>USDT</strong>.
        The strategy behind these returns relies on early identification of trends within the market, and closing positions
        quickly when the market goes against it.
