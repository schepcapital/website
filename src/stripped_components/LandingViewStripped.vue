...
<template>
  <div class="fullscreen-bg">
    ...
    <div class="text-overlay">
      ...
      <p class="cagr">A modern strategy for navigating financial markets*</p>
      <p class="note">*Detailed information about the strategy and its approach can be provided upon request. This does not constitute an offer to invest.</p>
    </div>
  </div>
</template>
